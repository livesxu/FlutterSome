...
- (void)setPhoto:(LGPhotoPickerBrowserPhoto *)photo {
    ...
    if (photo.photoPath.length) {
        ...
        if (photoRange.location != NSNotFound){
            ...
            [_photoImageView yy_setImageWithURL:photo.photoURL placeholder:thumbImage options:YYWebImageOptionProgressiveBlur|YYWebImageOptionSetImageWithFadeAnimation progress:^(NSInteger receivedSize, NSInteger expectedSize) {
