...
//  放一些方便使用的宏定义，如#define NSStringFromInt(intValue) [NSString stringWithFormat:@"%d",intValue]
...
/*navigaitonbar加状态栏高度*/
#define kStateAndNavigationBarHeight 64
...
// app build版本号
#define kAPPBuildVersion NSBundle.mainBundle.infoDictionary[@"CFBundleVersion"]
//获取当前语言
