    ...
    body: Column(
      children: <Widget>[
        ...
        Container(
          child: Card(
            child: Column(
              children: TomorrowThingsItems(state.model.tomorrowThings),
            ),
          )
        ),//明日之星
        Container(
...
List<Widget> TomorrowThingsItems(List<String> strings) {
...
//        maxLength: 50,//此限制输入长度方式会在右下角有长度的提示
      ...
      Container(child: IconButton(icon: Icon(Icons.add), onPressed: null),width: 50,height: 50,)
    ],
  );
  list.add(widgetLast);
